        ...
        <div id="about" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16">
            ...
            <div className="flex flex-col xl:flex-row xl:gap-20">
                <div className="xl:w-1/2">
                    <h4  className="text-3xl font-bold text-center text-gray-900 dark:text-gray-200">
                        Who am I?
                    </h4>
                    <div className="relative max-w-[261px] mt-8 m-auto border-4 p-20 border-gray-900 rounded-xl h-[294px] bg-gray-100 dark:bg-gray-700 shadow-lg shadow-gray-400 dark:shadow-gray-600">
                        <img className="rounded-xl absolute top-[45%] left-[45%] translate-x-[-50%]  translate-y-[-50%] bg-gray-100 dark:bg-gray-700 shadow-lg shadow-gray-400 dark:shadow-gray-600 hover:top-[50%] hover:left-[50%] ease-in duration-200" src={window.location.origin + '/img/tim.webp'} alt="A smiling Tim Sundell looking into the camera"/>
                    </div>
                ...
                <div className="xl:w-1/2">
                    ...
                    <p className="py-8 dark:text-gray-200">
                        After the summer of 2023, I will have my first internship, that's where you come into the picture! Below you will see a list of various skills I will
                        either master completely or have a good understanding of by the time we make acquaintance.<br></br><br></br> I am however open to learning something completely new during
                        my internship! So if you use other libraries/frameworks than the list you see below, no problem. Contact me and we can discuss a study plan so I'm well-prepared by the
