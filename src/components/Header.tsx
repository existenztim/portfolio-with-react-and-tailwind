...
const Header = () => {
  return (
    <div id="main">
        <img className="w-full h-screen object-cover object-left"src={window.location.origin + '/img/herobg.jpg'} />
        <div className="w-full h-screen absolute top-0 left-0 bg-white/50">
          <div className="max-w-[700] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center">
            ...
            <h2 className="flex sm:text-3xl text-2xl pt-4 text-gray-600">Aspiring front end developer
            <TypeAnimation
              sequence={[
                'One', // Types 'One'
                1000, // Waits 1s
