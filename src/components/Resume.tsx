...
const Resume = () => {
  return (
    <section className="w-screen bg-gradient-to-r from-slate-50 via-slate-100 to-slate-400">
        <div id="resume" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16">
            <h3 className="text-4xl font-bold text-center text-gray-900">Latest occupations</h3>
        ...
        <ol className="flex flex-col md:flex-row relative border-l border-stone-300">
            <li className="mb-10 ml-4">
                ...
                <p className="flex flex-wrap gap-4 flex-col  justify-start text-xs">
                    <span className="inline-block px-2 py-1 font-semibold text-white bg-slate-600 w-32 rounded-md">{occupation.year}</span>
